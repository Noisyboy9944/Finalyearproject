                ...
                >
                    <div className="relative z-10">
                        ...
                        <div className="w-full bg-black/20 rounded-full h-2 mt-4">
                            <div className="bg-white/80 h-2 rounded-full w-[85%] transition-all duration-1000" />
                        </div>
                    </div>
                ...
                {programs.map((program, idx) => (
                    ...
                    >
                        <Link 
                            ...
                            className="group bg-white border border-lms-secondary rounded-2xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 block"
                        >
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-sm text-lms-muted line-clamp-2 mb-4">{program.description}</p>
                                <div className="flex items-center gap-4 text-xs text-lms-muted mb-4">
